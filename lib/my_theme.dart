...
class MyTheme{
  ...
  static Color accent_color = Color.fromRGBO(36, 33, 36, 1);
  static Color accent_color_2 = Color.fromRGBO(230,46,4, 1);
  static Color soft_accent_color = Color.fromRGBO(153,153,153, 1);
  static Color soft_accent_color_2 = Color.fromRGBO(247,189,168, 1);
  static Color splash_login_screen_color = Color.fromRGBO(39,38,43, 1); // if not sure , use the same color as accent color
  ...
  static Color red = Color.fromRGBO(237, 41, 57, 1);
  ...
  static Color golden = Color.fromRGBO(255, 171, 0, 1);

  static Color red_disabled = Color.fromRGBO(237, 41, 57, .5);
  static Color lime_disabled = Color.fromRGBO(130, 180, 64, .5);
  static Color orange_disabled = Color.fromRGBO(255, 111, 0, .5);
